...
router.register('tools/common.list_supported_formats', async () => CommonTools.listSupportedFormats());
router.register('tools/common.preview_file_name', async (params) => CommonTools.previewFileName(params));
router.register('tools/common.validate_processing_date', async (params) =>
  CommonTools.validateProcessingDate(params)
);
router.register('tools/common.list_output_files', async (params) => CommonTools.listOutputFiles(params));
router.register('tools/common.read_output_file', async (params) => CommonTools.readOutputFile(params));
