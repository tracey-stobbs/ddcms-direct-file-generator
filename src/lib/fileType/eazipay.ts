  ...
  for (const fieldName of fieldsToInvalidate) {
    ...
    switch (fieldName) {
      ...
      case 'originatingSortCode':
        row.originatingSortCode = generateInvalidFieldValue(fieldName, row.transactionCode) as string;
        break;
      case 'originatingAccountNumber':
        row.originatingAccountNumber = generateInvalidFieldValue(fieldName, row.transactionCode) as string;
        break;
      case 'destinationSortCode':
        row.destinationSortCode = generateInvalidFieldValue(fieldName, row.transactionCode) as string;
        break;
      case 'destinationAccountNumber':
        row.destinationAccountNumber = generateInvalidFieldValue(fieldName, row.transactionCode) as string;
        break;
 ...
 */
function getOriginatingDetails(request: Request): { sortCode: string; accountNumber: string; accountName: string } {
