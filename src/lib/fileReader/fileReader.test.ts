...
describe('lib/fileReader', () => {
    ...
    it('rejects path traversal attempts', () => {
        ...
        const sun = '444444';
        expect(() =>
            readOutputFile({ fileType: 'SDDirect', sun, fileName: '../x.csv' }),
        ).toThrowError();
    });
    ...
    it('returns file not found for missing file', () => {
        const sun = '555555';
        expect(() =>
            readOutputFile({ fileType: 'SDDirect', sun, fileName: 'missing.csv' }),
